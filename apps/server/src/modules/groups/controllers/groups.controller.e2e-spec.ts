import { type HttpServer, httpStatusCode } from '@/shared/base/http-server'
import { serverModule } from '@/shared/server.module'
import request from 'supertest'

import { drizzleService } from '@/shared/database/drizzle/drizzle.service'
import * as schemas from '@/shared/database/drizzle/schemas'
import { data } from '@/shared/database/drizzle/seed/data'
